...
const testimonials = [
  {
    ...
    exam:    'SEE — Distinction',
    college: 'Budhanilkantha School',
    score:   '94%',
    text:    'Brighter Nepal\'s model sets were exactly like the real SEE exam. The detailed explanations helped me understand where I went wrong. Scored distinction on the first attempt!',
    initials:'AS',
    color:   'bg-[#1a1a4e]',
  },
  {
    ...
    score:   '91%',
    text:    'The live classes helped me ace science and math. The interactive sessions were incredibly helpful. I would recommend Brighter Nepal to every SEE student.',
    initials:'KT',
    color:   'bg-[#2d6a6a]',
  },
  {
    ...
    score:   '89%',
    text:    'The resource library is unmatched. 2,500+ materials all categorized by subject. I completed 12 full model sets in the last month and my accuracy jumped from 65% to 89%.',
    initials:'RK',
